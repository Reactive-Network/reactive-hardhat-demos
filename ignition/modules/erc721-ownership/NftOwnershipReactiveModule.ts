...
const ReactiveModule = buildModule("ReactiveModule", (m) => {
    const nftOwnershipL1: string  = deployedAddresses["NftOwnershipL1Module#NftOwnershipL1"];
    ...
    const reactiveContract = m.contract("NftOwnershipReactive", [nftOwnershipL1], {
