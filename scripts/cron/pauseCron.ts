...
async function main(): Promise<void> {
    ...
    const contractAddress = deployedAddresses["CronDemoModule#BasicCronContract"];
    if (!contractAddress) {
        throw new Error(`❌ CronDemoModule#BasicCronContract not found in deployed_addresses.json`);
    }
