...
async function main(): Promise<void> {
    ...
    const contractAddress = deployedAddresses["ReactiveModule#UniswapHistoryDemoReactive"];
    if (!contractAddress) {
        throw new Error(`❌ ReactiveModule#UniswapHistoryDemoReactive not found in deployed_addresses.json`);
    }
